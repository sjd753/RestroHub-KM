...
import com.ogma.restrohubadmin.activity.AddMenu;
...
public class TablesFragment extends Fragment implements View.OnClickListener {
    ...
    private class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.ViewHolder> {
        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
            ...
            public ViewHolder(View itemView) {
                super(itemView);
                tvName = (TextView) itemView.findViewById(R.id.tv_table_name);
                ivBtnEdit = (ImageButton) itemView.findViewById(R.id.iv_btn_table_edit);
                ivBtnDelete = (ImageButton) itemView.findViewById(R.id.iv_btn_table_delete);
    ...
    private class FetchTablesTask extends AsyncTask<String, Void, Boolean> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            snackbar = Snackbar.make(coordinatorLayout, "Fetching tables...", Snackbar.LENGTH_INDEFINITE);
            snackbar.show();
        }
